(function () {
    ...
    angular
        .module('marsApp')
        .controller('MarsVaultPwdGenController', MarsVaultPwdGenController);

    MarsVaultPwdGenController.$inject = ['$timeout', '$scope', '$uibModalInstance'];

    function MarsVaultPwdGenController($timeout, $scope, $uibModalInstance) {
        var vm = this;
        ...
        function save() {
            $scope.$emit('marsApp:MarsVaultPwdGen', vm.password);
